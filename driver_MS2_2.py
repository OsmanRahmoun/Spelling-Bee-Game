# DO NOT EDIT THIS FILE - need to reset? go to starter code page. 99
##########################
# Project 1 - driver_MS2_2
...
valid = True # get set to True once puzzle is properly generated
...
# This allows the user to play 3 times.
for i in range(3):
    if first_time:
